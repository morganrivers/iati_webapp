...
if '_app_initialized' not in st.session_state:
    with _loading_slot.container():
        ...
        with _c2:
            ...
            st.markdown("""
This tool forecasts the likely overall success rating and 14 binary outcomes of an aid activity at time of evaluation,
...
3. A Random Forest and ExtraTrees ensemble predicts a success rating on a 0–5 scale and 14 separate binary activity outcomes.
